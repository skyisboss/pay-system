...
func (bq *BalanceQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (bq *BalanceQuery) FirstIDX(ctx context.Context) uint64 {
...
func (bq *BalanceQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (bq *BalanceQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (bq *BalanceQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (bq *BalanceQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := bq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(balance.FieldCreatedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
func (bq *BalanceQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(balance.Table, balance.Columns, sqlgraph.NewFieldSpec(balance.FieldID, field.TypeUint64))
	_spec.From = bq.sql
